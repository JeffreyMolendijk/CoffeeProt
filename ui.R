  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "Report",
              ...
              fluidRow(box(title = "Export individual plots", status = "primary", width = 6,  uiOutput("downloadplotselect_ui"), selectInput("downloadplotfiletype", "Select filetype", choices = c("svg", "pdf", "png", "eps", "tiff", "bmp"), selected = "svg"), pickerInput("plotdims", "Select plot dimensions", choices = list(Size = c("Extra large" = 15 ,"Large" = 10, "Medium" = 8, "Small" = 5, "Extra small" = 3), Shape = c("Extra wide" = 2.5,"Wide"=1.6, "Square"=1)), selected = list(8, 1.6), multiple = T, options = list('max-options-group' = 1)), downloadButton("download_plot", "Download plot"))))
)))
